...
public class LAB11NO4 extends JPanel implements Runnable {
    private StillClock clock;
    private JLabel timeLabel;
    private Thread animation;
    public LAB11NO4(JPanel mainPanel, TimeZone zone) {
    ...
    public static void main(String[] args) {
        ...
        LAB11NO4 THClock = new LAB11NO4(THPanel, TimeZone.getTimeZone("Asia/Bangkok"));
